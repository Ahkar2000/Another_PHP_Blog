                    ...
                    <div class="card-body">
                        <form method="post">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="password" name="cpassword" min="8" class="form-control my-2" required>
                            </div>
                            <div class="form-group">
                                <button class="btn btn-primary" name="regbtn">Register</button>
                                <a class="btn btn-outline-primary text-decoration-none" href="login.php">Sign In</a>
                            </div>
                        </form>
                    </div>
                </div>
